addnode ;;2018-01-03 AKB test of round-trip communication; delete this, as the program will no longer do a roundtrip for add/delete
handle()
	;
  ...
  new testlocal,responseStr,responseStatusStr,typeStr,nameStr
  set (responseStr,responseStatusStr,typeStr,nameStr)=""
  set typeStr=push("type");
  set nameStr=push("namestring");
